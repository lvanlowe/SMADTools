...
namespace NotificationServiceTest.RepositoriesTest
{
    public class EmailRepositoryTest
    {
        ...
        public void TestSendEmail()
        {
            ...
            _repository.SendEmail(from,to,null, subject,plainTextContent,htmlContent).Wait();
        }
        ...
        public void SendEmailString()
        {
            ...
            _repository.SendEmailString(_fromEmail, _toEmail, subject, plainTextContent, htmlContent).Wait();
        }
